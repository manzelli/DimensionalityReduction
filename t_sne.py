...
def my_tsne(x, y=None, components=2, verbose=1, n_iter=500):
	time_start = time.time()
	tsne_red = TSNE(n_components=components, verbose=verbose, n_iter=n_iter, n_jobs=36)
