...
input_img = Input(shape=(784,)) # 784 is number of dimensions
...
# this model maps an input to its reconstruction - to evaluate loss
...
# Configure model using rmsprop optimizer for gradients and cross entropy loss function
